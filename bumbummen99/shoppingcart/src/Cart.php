...
class Cart
{
    ...
    public function destroy($identifier)
    {
        ...
        $this->getConnection()->table($this->getTableName())->where(['identifier' => $identifier, 'instance' => $identifier])->delete();
    }
     ...
     * @return void
     */
    public function updatestore($identifier)
    {
        $content = $this->getContent();
        ...
        if (!$this->storedCartInstanceWithIdentifierExists($instance, $identifier)) {
            throw new CartAlreadyStoredException("A cart with identifier {$identifier} is not stored.");
        }
     ...
     * @return void
     */
    public function checkout_restore($identifier)
    {
        if ($identifier instanceof InstanceIdentifier) {
            $identifier = $identifier->getInstanceIdentifier();
        }
